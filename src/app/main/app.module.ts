...
export function translateHttpLoader(http: Http) {
  return new TranslateHttpLoader(http, '/resources/i18n/', '.json');
}

export function translateService(translate: TranslateService) {
  return TranslationBaseHrefFactory.getBaseHref(translate)
}